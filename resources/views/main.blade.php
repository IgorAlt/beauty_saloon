    ...
    @endif
        ...
        @foreach($posts as $post)
            <div class="card" style="width: 27rem; display: inline-flex" >
                <img src="{{ $post->image_path }}" class="card-img-top" alt="{{ $post->name  }}">
                <div class="card-body">
            ...
            <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <img width="400px" src="{{  $master->image_path}}" alt="{{ $master->name }}">
                        <br>
                        ...
                        <br>
                        Информация: {{ mb_substr($master->information, 0, 50) . '... ' }} <a href="{{ route('master', $master->id) }}">Подробнее</a>
                    </div>
                </div>
            </div>
        </div>
